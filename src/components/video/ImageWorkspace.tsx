...
export const ImageWorkspace: React.FC<ImageWorkspaceProps> = ({ scriptId }) => {
    ...
    return (
        <>
            ...
            <ConfirmDialog isOpen={!!deleteConfirmVariantId} title="确认删除副本" message="确定要删除这个参考图副本吗？此操作不可撤销。" type="danger" confirmText="确认删除" onConfirm={confirmDeleteVariant} onCancel={() => setDeleteConfirmVariantId(null)} />
